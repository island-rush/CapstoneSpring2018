...
CREATE TABLE IF NOT EXISTS `placements`(
    ...
    FOREIGN KEY (transportId) REFERENCES placements(placementId),
...
CREATE TABLE IF NOT EXISTS `movements`(
    ...
    FOREIGN KEY (movementFromTransport) REFERENCES placements(placementId),
