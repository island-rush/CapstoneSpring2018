                ...
                if ($unitName == "transport") {
                    ...
                    if ($num_results > 0) {
                        for ($i=0; $i < $num_results; $i++) {
                            ...
                            $trans2 = $x['transportId'];
                            $unitMoves2 = $x['currentMoves'];
                            $placementId2 = $x['placementId'];
                            echo "<div class='".$unitName2." game_piece' data-trans='".$trans2."' data-unitName='".$unitName2."' data-moves='".$unitMoves2."' ";
                            echo "data-placementId='".$placementId2."' draggable='true' ondragstart='drag(event, this)'>";
                            echo "</div>";
