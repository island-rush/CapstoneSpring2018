...
<head>
    ...
    <script type="text/javascript">
        ...
        function allowDrop(event, element) {
            ...
            // hover_timer_start(event, element);
        }

        function hover_timer_start(event, element) {
            event.preventDefault();
            // clearTimeout(hovertimer);
            if (event.target.parentNode.classList[0] == "grid") {
                clearTimeout(hovertimer);
        ...
        function clear_hover_timer(event, element) {
            event.preventDefault();
            // alert(event.target.parentNode.classList[0]);
            if (event.target.parentNode.classList[0] == "grid") {
                clearTimeout(hovertimer);
                // alert("settimeout for hideall");
...
<!--            <div class="gridblockTiny" id="pos13j" data-positionId="65" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)">--><?php //$positionId = 65; include("display_pieces.php"); ?><!--</div>-->
        ...
        <div class="gridblock" data-positionId="1" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 1; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="2" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 2; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="3" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 3; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="4" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 4; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="5" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 5; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="6" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 6; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="7" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 7; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="8" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 8; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="9" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 9; include("display_pieces.php"); ?></div>
        <div class="gridblock" id="special_island1" onclick="make_big(event, this)" ondragenter="hover_timer_start(event, this)"></div>
        <div class="gridblock" data-positionId="10" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 10; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="11" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 11; include("display_pieces.php"); ?></div>
        <div class="gridblock" id="special_island2" onclick="make_big(event, this)"></div>
        <div class="gridblock" data-positionId="12" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 12; include("display_pieces.php"); ?></div>
        <div class="gridblock" id="special_island3" onclick="make_big(event, this)"></div>
        <div class="gridblock" data-positionId="13" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 13; include("display_pieces.php"); ?></div>
...
<!--            <div class="gridblockTiny" id="pos14j" data-positionId="75" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)">--><?php //$positionId = 75; include("display_pieces.php"); ?><!--</div>-->
        ...
        <div class="gridblock" data-positionId="14" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 14; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="15" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 15; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="16" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 16; include("display_pieces.php"); ?></div>
        <div class="gridblock" id="special_island4" onclick="make_big(event, this)"></div>
        <div class="gridblock" data-positionId="17" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 17; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="18" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 18; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="19" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 19; include("display_pieces.php"); ?></div>
        <div class="gridblockEmptyLeft" onclick="hideall_big()"></div>
        <div class="gridblock" data-positionId="20" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 20; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="21" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 21; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="22" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 22; include("display_pieces.php"); ?></div>
        <div class="gridblock" id="special_island5" onclick="make_big(event, this)"></div>
        <div class="gridblock" data-positionId="23" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 23; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="24" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 24; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="25" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 25; include("display_pieces.php"); ?></div>
        <div class="gridblock" id="special_island6" onclick="make_big(event, this)"></div>
        <div class="gridblock" data-positionId="26" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 26; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="27" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 27; include("display_pieces.php"); ?></div>
        <div class="gridblock" id="special_island7" onclick="make_big(event, this)"></div>
        <div class="gridblock" data-positionId="28" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 28; include("display_pieces.php"); ?></div>
        <div class="gridblock" id="special_island5" onclick="make_big(event, this)"></div>
        <div class="gridblock" data-positionId="29" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 29; include("display_pieces.php"); ?></div>
        <div class="gridblock" id="special_island8" onclick="make_big(event, this)"></div>
        <div class="gridblock" data-positionId="30" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 30; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="31" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 31; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="32" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 32; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="33" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 33; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="34" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 34; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="35" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 35; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="36" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 36; include("display_pieces.php"); ?></div>
        <div class="gridblock" id="special_island9" onclick="make_big(event, this)"></div>
        <div class="gridblock" data-positionId="37" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 37; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="38" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 38; include("display_pieces.php"); ?></div>
        <div class="gridblock" id="special_island10" onclick="make_big(event, this)"></div>
        <div class="gridblock" data-positionId="39" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 39; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="40" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 40; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="41" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 41; include("display_pieces.php"); ?></div>
        <div class="gridblock" id="special_island11" onclick="make_big(event, this)"></div>
        <div class="gridblock" data-positionId="42" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 42; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="43" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 43; include("display_pieces.php"); ?></div>
        <div class="gridblock" id="special_island12" onclick="make_big(event, this)"></div>
        <div class="gridblock" data-positionId="44" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 44; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="45" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 45; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="46" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 46; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="47" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 47; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="48" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 48; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="49" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 49; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="50" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 50; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="51" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 51; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="52" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 52; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="53" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 53; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="54" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 54; include("display_pieces.php"); ?></div>
        <div class="gridblock" data-positionId="55" onclick="hideall_big()" ondragover="allowDrop(event, this)" ondrop="drop(event, this)"><?php $positionId = 55; include("display_pieces.php"); ?></div>
        <div id="bigblock1" class="bigblock bigblock3x3" ondragleave="clear_hover_timer(event, this)">
